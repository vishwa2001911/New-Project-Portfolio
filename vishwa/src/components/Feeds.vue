<template>
  <div class="feeds">
    ...
    <div class="feedBoxProfile">
        <img src="../assets/my.jpg" alt="" class="feedBoxeProfileImag">
        <div class="feedProfile-box">
            <h1 class="feedProfileName">Vish</h1>
            <span>
            ...
            <h5 class="feedDate">20 Jan 2023</h5>
        </div>
        <div class="feedProfileInfo">

            <div class="feedFeelingBox">
                <span class="feelingIcon">
    ...
    <div class="reactBox">
        ...
        <span class="react">
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
